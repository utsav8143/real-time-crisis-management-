    ...
    <div className="">
      <div className="border-b-white border-b flex justify-between items-center">
        <div className="flex items-center  pb-2">
          ...
          <div className="flex items-center gap-2 justify-center mt-4 ms-12">
        ...
        <div className="">
          <div className="">
            <Link to="/report" className="flex items-center font-bold text-primary border p-2 rounded-full mt-2">Report <div className="h-2 w-2 bg-primary rounded-full ms-1"></div></Link>
          </div>
        </div>
      </div>
    </div>
