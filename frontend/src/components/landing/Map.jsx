...
const Map = () => {
  ...
  bg-size-[40px_40px] opacity-70 relative">
    ...
    <div className="bg-yellow-400  animate-pulseY shrink h-2 w-2 rounded-xl absolute top-49 left-99 group hidden lg:block"><div className='group-hover:block text-gray-400 w-20 h-12 text-center absolute top-10 -left-8 hidden  '>Zone-33 , FLOOD</div></div>
