...
const Map = () => {
  return (
    <section className='scroll-m-5' id="map">
    <div className="mt-20">
        ...
        <div className="border-r border-gray-700 w-full h-100 mt-15 bg-gray-900 bg-[linear-gradient(to_right,#424242_1px,transparent_1px),linear-gradient(to_bottom,#424242_1px,transparent_0.5px)]
  bg-size-[40px_40px] opacity-70 relative">
    ...
    <div className="bg-red-400  animate-pulseR shrink h-2 w-2 rounded-xl absolute top-79 left-59 group"><div className='group-hover:block text-gray-400 w-20 h-12 text-center absolute top-10 -left-8 hidden  '>Zone-17 , MEDICAL</div></div>
    ...
    <div className="bg-green-400  animate-pulseG shrink h-2 w-2 rounded-xl absolute top-29 left-249 group"><div className='group-hover:block text-gray-400 w-20 h-12 text-center absolute top-10 -left-8 hidden  '>Zone-04 , STRUCTURAL DAMAGE</div></div>
    <div className="bg-blue-400  animate-pulseB shrink h-2 w-2 rounded-xl absolute top-89 left-159 group"><div className='group-hover:block text-gray-400 w-20 h-12 text-center absolute top-10 -left-8 hidden  '>Zone-01, FIRE</div></div>
