    ...
    <div className="">
      ...
      <div className="border-b-gray-700 border-b flex justify-between items-center">
        <div className="flex items-center pb-2">
          ...
          <div className="flex items-center lg:gap-2 gap-1 justify-center mt-4 lg:ms-30">
      ...
      <div className="flex ">
        <div className="border-r border-gray-700 border-l  lg:w-1/7 w-1/4 h-screen hidden lg:block">
          <div
